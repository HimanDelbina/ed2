...
class BazarganiRequestPage extends StatefulWidget {
  const BazarganiRequestPage({super.key});

  @override
  State<BazarganiRequestPage> createState() => _BazarganiRequestPageState();
}

class _BazarganiRequestPageState extends State<BazarganiRequestPage> {
  @override
  void initState() {
    bazarganiGetShop();
    super.initState();
  ...
  Future<void> bazarganiGetShop() async {
    String infourl = Helper.url.toString() + 'anbar/get_shop_by_bazargani';
  ...
  Future editShop() async {
    ...
    var body = jsonEncode({
      "bazargani_accept": isSelect ? true : false,
      "bazargani_date": dateTimeString
    });
