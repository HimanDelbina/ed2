...
class ExportCommodityPage extends StatefulWidget {
  const ExportCommodityPage({super.key});

  @override
  State<ExportCommodityPage> createState() => _ImportCommodityPageState();
}

class _ImportCommodityPageState extends State<ExportCommodityPage> {
  bool? is_sadaf = false;
  bool? is_mahtab = true;
  bool? is_mavad = false;
  bool? is_kala = true;
    ...
    return Padding(
      ...
      child: ListView(
        children: [
          ...
          my_form(controllerCount, count, "تعداد کالا", false, Icons.height,
