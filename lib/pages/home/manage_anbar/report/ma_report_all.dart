...
import 'package:ed/models/anbar/anbar_request_model.dart';
import 'package:http/http.dart' as http;
import '../../../../static/helper_page.dart';

class ManagerAnbarReportAll extends StatefulWidget {
  const ManagerAnbarReportAll({super.key});

  @override
  State<ManagerAnbarReportAll> createState() => _ManagerAnbarReportAllState();
}

class _ManagerAnbarReportAllState extends State<ManagerAnbarReportAll> {
  @override
  void initState() {
    super.initState();
    get_all_anbar();
                            ...
                            child: Column(
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      "درخواست کننده : ${data![index].user.firstName} ${data![index].user.lastName}",
                                ...
                                data![index].description == ""
                                    ? const Text("توضیحات : توضیحات ندارد")
                                    : Text(
                                        "توضیحات : ${data![index].description}"),
                                const Text("اجناس : "),
                                Column(
                                  children: List.generate(
                                    data![index].commodities.length,
                                    (y) => Row(
                                      mainAxisAlignment:
                                          MainAxisAlignment.spaceBetween,
                                      children: [
                                        Text(
                                            "${data![index].commodities[y].name} به تعداد : ${data![index].commodities[y].count.toString().toPersianDigit()} ${data![index].commodities[y].unit}"),
                                        Text(
                                          data![index].isAccept
                                              ? "تایید شده"
                                              : "تایید نشده",
                                  ...
                                  children: [
                                    Text(
                                      data![index].managerAccept ||
                                              data![index].salonAccept
                                          ? "تاییدیه مدیر : تایید شده"
                                          : "تاییدیه مدیر : تایید نشده",
                                      style: TextStyle(
                                          color: data![index].managerAccept ||
                                                  data![index].salonAccept
                                              ? Colors.green
                                              : Colors.red),
                                    ),
                                    data![index].managerAccept ||
                                            data![index].salonAccept
                                        ? Text(
                                            "تاریخ تایید : ${FormateDateCreateChange.formatDate(data![index].acceptDate.toString())}")
                                        : const SizedBox(),
                                  ],
                                ),
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      data![index].anbarAccept
                                          ? "تاییدیه انبار : تایید شده"
                                          : "تاییدیه انبار : تایید نشده",
                                      style: TextStyle(
                                          color: data![index].anbarAccept
                                              ? Colors.green
                                              : Colors.red),
                                    ),
                                    data![index].anbarAccept
                                        ? Text(
                                            "تاریخ تایید : ${FormateDateCreateChange.formatDate(data![index].anbarDate.toString())}")
                                        : const SizedBox(),
                                  ],
                                ),
                              ],
  ...
  Future get_all_anbar() async {
    is_all_filter!
        ? infourl = Helper.url.toString() + 'anbar/get_all_anbar'
        : is_start_date!
    ...
    // String infourl = Helper.url.toString() + 'anbar/get_all_anbar';
