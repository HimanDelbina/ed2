...
class ManagerAnbarReportAllTable extends StatefulWidget {
  const ManagerAnbarReportAllTable({super.key});

  @override
  State<ManagerAnbarReportAllTable> createState() =>
      _ManagerAnbarReportAllState();
}

class _ManagerAnbarReportAllState extends State<ManagerAnbarReportAllTable> {
  @override
  void initState() {
    super.initState();
    get_all_anbar();
                            ...
                            rows: data!.map((item) {
                              return DataRow(cells: [
                                ...
                                DataCell(Column(
                                  ...
                                  children:
                                      item.commodities.map<Widget>((commodity) {
                                ...
                                DataCell(Text(
                                  item.anbarAccept ? "تایید شده" : "تایید نشده",
                                  style: TextStyle(
