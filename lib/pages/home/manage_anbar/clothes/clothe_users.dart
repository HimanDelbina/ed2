import 'package:ed/pages/home/manage_anbar/clothes/clothe_select.dart';
...
class ClotheUsers extends StatefulWidget {
  const ClotheUsers({super.key});

  @override
  State<ClotheUsers> createState() => _ClotheUsersState();
}

class _ClotheUsersState extends State<ClotheUsers> {
  @override
  void initState() {
    get_all_users();
    super.initState();
