...
import 'package:ed/pages/home/kargozini/users/edit_user_page.dart';
import 'package:url_launcher/url_launcher.dart';

import '../../../../models/users/get_all_user_model.dart';
import '../../../../static/helper_page.dart';

class KargoziniUserMahtabPage extends StatefulWidget {
  const KargoziniUserMahtabPage({super.key});

  @override
  State<KargoziniUserMahtabPage> createState() =>
      _KargoziniUserMahtabPageState();
}

class _KargoziniUserMahtabPageState extends State<KargoziniUserMahtabPage> {
  ...
  Future get_all_users() async {
    is_all!
        ? infourl =
            Helper.url.toString() + 'user/get_all_user_filter/?company_id=${1}'
        : is_active!
            ? infourl = Helper.url.toString() +
                'user/get_all_user_filter/?is_active=1&company_id=${1}'
            : is_notActive!
                ? infourl = Helper.url.toString() +
                    'user/get_all_user_filter/?is_active=0&company_id=${1}'
                : infourl = Helper.url.toString() +
                    'user/get_all_user_filter/?company_id=${1}';
