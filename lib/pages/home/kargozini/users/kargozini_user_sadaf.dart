...
class KargoziniUserSadafPage extends StatefulWidget {
  const KargoziniUserSadafPage({super.key});

  @override
  State<KargoziniUserSadafPage> createState() =>
      _KargoziniUserMahtabPageState();
}

class _KargoziniUserMahtabPageState extends State<KargoziniUserSadafPage> {
  ...
  Future get_all_users() async {
    is_all!
        ? infourl =
            Helper.url.toString() + 'user/get_all_user_filter/?company_id=${2}'
        : is_active!
            ? infourl = Helper.url.toString() +
                'user/get_all_user_filter/?is_active=1&company_id=${2}'
            : is_notActive!
                ? infourl = Helper.url.toString() +
                    'user/get_all_user_filter/?is_active=0&company_id=${2}'
                : infourl = Helper.url.toString() +
                    'user/get_all_user_filter/?company_id=${2}';
